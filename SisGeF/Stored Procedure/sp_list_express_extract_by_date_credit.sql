CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_list_express_extract_by_date_credit`( 
    in pDatecredit date
)
BEGIN
select	expressas_extrato.id_extrato as id_extrato, 
        ...
        expressas_extrato.val_volumes_extra as val_volumes_extra, 
        ...
        expressas_extrato.val_producao as val_producao, 
        ...
        expressas_extrato.val_total_expressa as val_total_expressa, 
	...
	where expressas_extrato.dat_credito = pDatecredit;	
END